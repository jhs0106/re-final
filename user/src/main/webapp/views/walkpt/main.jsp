    ...
    <div class="container">
        ...
        <div class="tab-content mt-5">
            ...
            <div class="tab-pane fade show active" id="jobPostings" role="tabpanel">
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.user}">
                        <a href="<c:url value='/walkpt/owner/post-write'/>" class="mobile-action-btn btn-danger">
                            <i class="fas fa-plus"></i> 구인 글 작성
                        </a>
                    </c:when>
                    <c:otherwise>
                        <button class="mobile-action-btn btn-danger" onclick="showLoginRequired()">
                            <i class="fas fa-plus"></i> 구인 글 작성
                        </button>
                    </c:otherwise>
                </c:choose>
            ...
            <div class="tab-pane fade" id="workerPostings" role="tabpanel">
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.user}">
                        <a href="<c:url value='/walkpt/worker/job-post-write'/>" class="mobile-action-btn btn-success">
                            <i class="fas fa-plus"></i> 구직 글 작성
                        </a>
                    </c:when>
                    <c:otherwise>
                        <button class="mobile-action-btn btn-success" onclick="showLoginRequired()">
                            <i class="fas fa-plus"></i> 구직 글 작성
                        </button>
                    </c:otherwise>
                </c:choose>
            ...
            <div class="tab-pane fade" id="togetherWalk" role="tabpanel">
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.user}">
                        <a href="<c:url value='/walkpt/togetherwalk/write'/>" class="mobile-action-btn btn-info">
                            <i class="fas fa-plus"></i> 함께 산책하기
                        </a>
                    </c:when>
                    <c:otherwise>
                        <button class="mobile-action-btn btn-info" onclick="showLoginRequired()">
                            <i class="fas fa-plus"></i> 함께 산책하기
                        </button>
                    </c:otherwise>
                </c:choose>
