                    ...
                    <div class="info-card">
                        ...
                        <form id="profileForm">
                            ...
                            <div class="form-group-mypage">
                                ...
                                <input type="text" class="form-control-mypage readonly"
                            ...
                            <div class="form-group-mypage">
                                <label>이름</label>
                                <input type="text" class="form-control-mypage" id="name"
                            ...
                            <div class="form-group-mypage">
                                <label>이메일</label>
                                <input type="email" class="form-control-mypage" id="email"
                            ...
                            <div class="form-group-mypage">
                                <label>전화번호</label>
                                <input type="tel" class="form-control-mypage" id="phone"
                                       value="${user.phone}" placeholder="010-1234-5678">
                            </div>
                        ...
                        <form id="passwordForm">
                            <div class="form-group-mypage">
                                ...
                                <div class="password-toggle-wrapper">
                                    <input type="password" class="form-control-mypage"
                                           id="currentPassword" placeholder="현재 비밀번호">
                            ...
                            <div class="form-group-mypage">
                                ...
                                <div class="password-toggle-wrapper">
                                    <input type="password" class="form-control-mypage"
                                           id="newPassword" placeholder="8자 이상, 영문+숫자+특수문자">
                                    <button type="button" class="password-toggle-btn"
            ...
            <div id="tab-pets" class="tab-panel">
                ...
                <c:if test="${user.role == 'GENERAL' && (empty pets || petCount == 0)}">
                    <div class="empty-pet-notice">
                        ...
                        <ul style="text-align: left; display: inline-block; margin: 0 auto 2rem; color: #495057;">
                        ...
                        <button class="btn-mypage-primary" onclick="showAddPetModal()" style="font-size: 1.1rem; padding: 1rem 2rem;">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group-mypage">
                ...
                <input type="password" class="form-control-mypage"
                       id="deleteConfirmPassword" placeholder="비밀번호 입력">
            </div>
            <div class="form-group-mypage">
                <label>
        ...
        <div class="modal-body">
            <form id="petForm">
                ...
                <div class="form-group-mypage">
                    ...
                    <input type="text" class="form-control-mypage" id="petName"
                ...
                <div class="form-row-2">
                    ...
                    <div class="form-group-mypage">
                        <label>품종</label>
                        <input type="text" class="form-control-mypage" id="petBreed"
                ...
                <div class="form-row-2">
                    ...
                    <div class="form-group-mypage">
                        ...
                        <input type="number" class="form-control-mypage" id="petAge"
                ...
                <div class="form-group-mypage">
                    ...
                    <input type="number" class="form-control-mypage" id="petWeight"
                           placeholder="몸무게" step="0.1" min="0" required>
                </div>
            </form>
        </div>
        <div class="modal-footer">
