                        ...
                        <div class="pet-card-body">
                            ...
                            <div class="form-row-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control-auth" name="petName"
                                ...
                                <div class="form-group">
                                    <label><i class="fas fa-paw mr-1"></i> 종류 <span
                                            class="required">*</span></label>
                                    <select class="form-control-auth" name="petType" id="petType"
                            ...
                            <div class="form-row-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control-auth" name="petBreed"
                            ...
                            <div class="form-row-group">
                                ...
                                <div class="form-group">
                                    <label><i class="fas fa-birthday-cake mr-1"></i> 나이 <span
                                            class="required">*</span></label>
                                    <input type="number" class="form-control-auth" name="petAge"
                                ...
                                <div class="form-group">
                                    <label><i class="fas fa-weight mr-1"></i> 몸무게 <span
                                            class="required">*</span></label>
                                    <input type="number" class="form-control-auth" name="petWeight"
